    ...
    <div className="bg-white py-24 sm:py-32" id='about'>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-lg font-semibold leading-8 tracking-tight text-indigo-600">Quality and Dependable Services</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Empowering Your Financial Wellbeing
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
At Kismet Finance Group, we make it easy for you to access quality and dependable
financial and wealth creation services. Our services platform provides you with the
flexibility to select the methods that are most suitable for your goals of improving
