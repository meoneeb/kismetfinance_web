...
const features = [
  {
    ...
    description: 'Take a close look at your existing loan arrangements and consider restructuring your finances. This could save you thousands of dollars each year.',
    icon: BsPiggyBank,
  },
  // { name: 'List view', description: 'Corporis asperiores ea nulla temporibus asperiores non tempore assumenda aut.' },
  {
    name: 'Financial Planner',
    description: 'At Kismet Finance Group, we provide personalized financial planning and advice tailored to meet your individual needs and goals',
    icon: GiChart,
  },
  {
    name: 'Accountant',
    description: 'At our firm, we offer Accounting insights for all, from the selfemployed to business owners. Our team is ready to provide the guidance you need to make the best financial decisions.',
    icon: BsCalculator,
  },
  {
    name: 'Property Specialists', description: 'Creating financial security through real estate and construction projects.',

    icon: GiHouse,  },
  {
    name: 'Quantity Surveyors', description: 'We can help you get the most out of the tax advantages available to you, both for properties you already own and any new properties you may acquire.',
    icon: FaWpforms,
  },
  {
    name: 'First Home Buyers',
    description: 'We can help you with managing your finances, finding the right house and land package that suits your needs, and making sure everything is in order for you to settle in your new home.',
    icon: FaHouseUser,
  },
  // {
  //   name: 'Mobile app',
